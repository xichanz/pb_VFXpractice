    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + ((_normal_var.rgb.rg+mul( UNITY_MATRIX_V, float4(i.normalDir,0) ).xyz.rgb.rg)*_Re_intensity*i.vertexColor.a*node_7035);
...
/// Final Color:
                ...
                return fixed4(finalColor * (i.vertexColor.a*(pow(1.0-max(0,dot(normalDirection, viewDirection)),_Fresnel_opacity)*_Opacity)),0);
            }
            ENDCG
        }
        Pass {
